...
const LANG_META: Record<Lang, {
  ...
  en: {
    title: 'Paint by Number Pattern Maker — Free Custom PBN Generator | PaintKit',
  ...
  ko: {
    title: '페인트 바이 넘버 도안 생성기 — 사진으로 도안 만들기 | PaintKit',
  ...
  ja: {
    title: 'ペイントバイナンバー図案作成 — 写真から無料で作れる | PaintKit',
